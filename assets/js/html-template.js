...
const createBackToHomeButton = function () {
    ...
    backHomeButtonWrapper.innerHTML =
        '<a id="btn-back-home" class="btn-common btn-inverted-colors" href="index.html">Retour à l\'accueil<span class="teddy-bear-head-icon"></span></a>\n';
